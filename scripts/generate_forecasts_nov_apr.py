...
def generate_forecasts_for_period(
    ...
    Trains a DirectForecastEnsemble for each cutoff date.
    ...
    for cutoff_date in cutoff_dates:
        ...
        try:
            ...
            # Train a DirectForecastEnsemble on data up to cutoff
            ensemble = DirectForecastEnsemble(forecast_horizon=forecast_horizon)
